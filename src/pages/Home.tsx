...
const LinkStyled = ({ to = "#", children }: PropsWithChildren<LinkProps>) => {
  ...
  return (
    <Link to={to} ref={ref} className="w-full max-w-[600px] transition-transform active:scale-95">
...
const JoinGameButton = () => {
  return (
    <LinkStyled to={ENDPOINTS.joinGame}>
      ...
      <span className="ml-[10%] text-[calc(1rem_+_1vw)] backdrop-blur-md md:ml-0">Join a Tournament</span>
    </LinkStyled>
  );
};
...
const CreateTournamentButton = () => {
  return (
    <LinkStyled to={ENDPOINTS.createTournament}>
      ...
      <span className="ml-[10%] text-[calc(1rem_+_1vw)] backdrop-blur-md md:ml-0">Create a Tournament</span>
    </LinkStyled>
  );
};
